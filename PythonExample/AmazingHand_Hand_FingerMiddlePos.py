...
MiddlePos_1 = -15 #Middle position for servo ID_1 
MiddlePos_2 = 15 #Middle position for servo ID_2
MiddlePos_3 = 5 #Middle position for servo ID_3
MiddlePos_4 = -5 #Middle position for servo ID_4
MiddlePos_5 = 2 #Middle position for servo ID_5
MiddlePos_6 = -2 #Middle position for servo ID_6
